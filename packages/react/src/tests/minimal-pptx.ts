...
${Array.from({ length: SLIDE_COUNT }, (_, i) => `<Override PartName="/ppt/slides/slide${i + 1}.xml" ContentType="application/vnd.openxmlformats-officedocument.presentationml.slide+xml"/>`).join("\n")}
...
<p:sldIdLst>
${Array.from({ length: SLIDE_COUNT }, (_, i) => `<p:sldId id="${256 + i}" r:id="rId${2 + i}"/>`).join("\n")}
</p:sldIdLst>
...
${Array.from({ length: SLIDE_COUNT }, (_, i) => `<Relationship Id="rId${2 + i}" Type="http://schemas.openxmlformats.org/officeDocument/2006/relationships/slide" Target="slides/slide${i + 1}.xml"/>`).join("\n")}
<Relationship Id="rId${2 + SLIDE_COUNT}" Type="http://schemas.openxmlformats.org/officeDocument/2006/relationships/theme" Target="theme/theme1.xml"/>
</Relationships>`;
