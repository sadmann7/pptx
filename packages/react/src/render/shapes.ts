...
export function getShapePath(shapeType: string): ShapePathProps {
  switch (shapeType) {
    ...
    case 'curvedRightArrow':
      return {
        element: 'path',
        attrs: { d: 'M 20 100 L 20 40 L 60 40 L 60 20 L 100 50 L 60 80 L 60 60 L 40 60 L 40 100 Z' },
      }
    ...
    case 'plus':
      return {
        element: 'polygon',
        attrs: { points: '35,0 65,0 65,35 100,35 100,65 65,65 65,100 35,100 35,65 0,65 0,35 35,35' },
      }
    ...
    case 'can':
      return {
        element: 'path',
        attrs: { d: 'M 0 15 A 50 15 0 0 0 100 15 L 100 85 A 50 15 0 0 1 0 85 Z M 0 15 A 50 15 0 0 1 100 15' },
      }
