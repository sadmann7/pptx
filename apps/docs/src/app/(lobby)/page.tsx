  ...
  return (
    <section className="container flex flex-col items-center justify-center gap-6 pt-6 pb-8 md:py-10">
      <div className="flex max-w-5xl flex-col items-center gap-4">
        <h1
          className="animate-fade-up text-center text-4xl/tight leading-tight font-bold tracking-tighter text-balance opacity-0 md:text-5xl/tight"
          style={{ animationDelay: "0.20s", animationFillMode: "forwards" }}
        >
          {siteConfig.name}
        </h1>
        <p
          className="animate-fade-up text-center text-lg font-light text-balance opacity-0 md:text-xl"
